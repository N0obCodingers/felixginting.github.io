...
<head>
    ...
    <title>Felix Ginting Website</title>
    <!-- font icons -->
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Felix Ginting</h1>
                <h6 class="header-mono" >Web Developer and Game Developer</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        <h5 class="brand-title">Felix Ginting</h5>
                        <div class="brand-subtitle">Web Developer and Game Developer</div>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A Website designer and Application developer</h5>
                <p class="mt-20">Keep the spirit to achieve something, try and work hard with the help of prayer to God</p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 16/07/2005</li>
                    <li><span>Email</span> : felixginting712@gmail.com</li>
                    <li><span>Phone</span> : +6285763190221</li>
                    <li><span>Facebook</span> : Felix Ginting </li>
                    <li><span>Instagram</span> :  @felixginting_manik</li>
                    <li><span>Address</span> :  Delitua, Sumatera Utara Indonesia</li>
                </ul>
                <ul class="social-icons pt-3">
                    ...
                    <li class="social-item"><a class="social-link" href="#"><i class="ti-youtube" aria-hidden="true"></i></a></li>
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>Web Developer</h6>
                        <p class="subtitle"> Experts work on websites quickly and I can be paid cheaply.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>UX Developer</P>
                            <P class="subtitle">I work for people very well, in order to satisfy customers.</P>
                            <hr>
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>High School at SMAN 1 DELITUA</P>
                            <P class="subtitle">LIn this school I majored in social</P>
                            <hr>
                            <h6 class="title text-danger">2017-2020</h6>
                            <P>Junior High School at SMP KATOLIK RK DELI MURNI DELITUA</P>
                            <P class="subtitle">In junior high school I began to learn about what is wrong and what is right, I learned a lot here.</P>
                            <hr>
                            <h6 class="title text-danger">2011-2017</h6>
                            <P>Elementary school at SD KRISTEN ANDREAS and SD SWASTA SINGOSARI</P>
                            <P class="subtitle">In elementary school I started to learn to count, draw or color, write well and many more.</P>
                            <hr>
                            <h6 class="title text-danger">2010-2011</h6>
                            <P>Kindergarden at TK GLORIA MEDAN HELVETIA</P>
                            <P class="subtitle">In kindergarten I learn many things for example, study etc.</P>
                            <hr>
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body pb-2">
                           <h6>Java</h6>
                            ...
                            <h6>C++ &amp; C#</h6>
                            <div class="progress mb-3">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 86%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row">
                        ...
                        <div class="col-7 text-left py-3">
                            <h1 class="text-danger font-weight-bold font40">450</h1>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+6285763190221</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">Delitua Sumatera Utara, Indonesia.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">felixginting712@gmail.com</span></h6>
                            </div>
                        </div>
